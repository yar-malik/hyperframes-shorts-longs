...
The MIT License applies to the source code and documentation in this repository. It does not grant rights to third-party trademarks or to a person’s likeness and voice.

The included Yar Malik presenter footage, portrait, Instagram avatar, and voice recordings remain © 2026 Yar Malik. They are included in this repository so authorized teammates can study and reproduce the editing and carousel workflows. Do not use them to impersonate Yar Malik or imply an endorsement.

Google, Google Flow, and other referenced product names and screenshots belong to their respective owners. The Alex / nocodealex reel is linked as editing inspiration and is not redistributed here.
